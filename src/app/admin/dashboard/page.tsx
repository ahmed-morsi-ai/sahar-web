  ...
  try {
          ...
          <aside className="h-fit min-w-0 rounded-2xl border border-gold/15 bg-white/[0.045] p-5 backdrop-blur-2xl">
            ...
            <div className="mt-5 grid gap-3">
              <Link
                ...
                className="rounded-2xl border border-gold/15 px-4 py-3 text-sm text-ivory/70 transition hover:border-gold/35 hover:text-gold"
              >
    ...
    return (
      <div>
        <AdminHeader
          title="Dashboard"
          copy="The admin dashboard could not load its data right now."
        />
        ...
        <div className="rounded-2xl border border-red-400/25 bg-red-500/10 p-6 text-red-100 backdrop-blur-2xl">
          ...
          <p className="mt-3 max-w-2xl text-sm leading-6 text-red-100/75">
            The database or admin API did not respond. Check your PostgreSQL
            connection and ensure all environment variables are correctly
